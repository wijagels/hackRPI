...
public:
	...
	double getForce(double trueAccel, int type)
	{
		DataCollector dc;
		...
		{
		case 1:
			dc.forearm = dc.massSmallForearm;
			break;
		case 2:
			dc.forearm = dc.massAvgForearm;
			break;
		case 3:
			dc.forearm = dc.massLargeForearm;
			break;
		}

		return dc.forearm*trueAccel;
	...
	int roll_w, pitch_w, yaw_w, acc;
	double massSmallForearm;
	double massAvgForearm;
	double massLargeForearm;
	double forearm;
	double maxForce;
	double maxAccel;
